...
def mail():
    ...
    try:
        mail_msg = """
<p>This is Python3 smtp email test(HTML Type).</p>
<p><a href="https://github.com/Knio/pynmea2">This is pynmea2 github link url</a></p>
"""
        msg = MIMEText(mail_msg, 'html', 'utf-8')        # 修改为html的格式      
        ...
        server.sendmail(my_sender, my_receiver, msg.as_string())  # 括号中对应的是发件人邮箱账号、收件人邮箱账号(列表类型)、发送邮件
        server.quit()  # 关闭连接
